...
export default function TeaiRagIntvQA() {
  ...
  async function handleSubmitQA(e) {
    ...
    try {
      ...
      // "https://intv-qa-assistant-1.onrender.com/api/query"
        ...
        <main>
          ...
          {showPT && (
            <>
              ...
              <p className='h5homem'>
                <span style={{ lineHeight: '0.7em', fontSize: '0.85em', color: '#666', maxWidth: 840 }}>
              ...
              <p className='h5homem'>
                <span style={{ lineHeight: '0.7em', fontSize: '0.85em', color: '#666', maxWidth: 840 }}>
                  <br />PT uses .yaml files grouping of a lot of info. &nbsp;md files are hierarchical allowing advanced searches.<br /> 
                  The 97110.yaml has a section called "quick_facts".<br /> 
                  A search for "97110 quick_facts" is productive. But you must know the files. ... more later.
                </span>
              </p>
                    ...
                    <details>
                      ...
                      <div style={{ marginTop: '10px', fontSize: '0.85em', color: '#666' }}>
                        ...
                        {answer.sources && answer.sources.length > 0 && (
                          <div><strong>Sources:</strong> {[...new Set(answer.sources)].join(", ")}</div>
                        )}
                        {answer.use_fallback && (
