                ...
                <tbody>
                  <tr>
                    <td style={leftCellStyle}>
                        ...
                        <p style={{paddingTop: '4px', fontSize: '20px', color: '#1234c7' }}><b>Use the TEAIMP3Maker</b></p>
                    ...
                    <tr>
                      <td style={leftCellStyle}>
                          <div style={{ height: '44px' }} />
                          <p style={{paddingTop: '4px', fontSize: '20px', color: '#1234c7' }}><b>Occasionally, a slower .mp3 is required.</b></p>
                    ...
                    <tr>
                      <td style={leftCellStyle}>
                          <div style={{ height: '44px' }} />
                          <p style={{paddingTop: '4px', fontSize: '20px', color: '#1234c7' }}><b>Occasionally, a faster .mp3 is required.</b></p>
