...
{/* =============================================================================== */}
<h1 className="bTopBlue">React</h1>
<pre>

<h2>React: Error Boundaries</h2>
<p>Error boundaries are React components that catch JavaScript errors in their child component tree,<br /> 
    log those errors, and display a fallback UI instead of crashing the entire component tree.</p>
<p>They are useful for gracefully handling errors in a React application.</p>  
<p>
    <a target="blank" href="https://react.dev/reference/react/Component#catching-rendering-errors-with-an-error-boundary">
    Catching rendering errors with an error boundary</a>
</p>
...
{/* =============================================================================== */}
<h1 className="bTopBlue">ASCII</h1>
...
{/* =============================================================================== */}
<h1 className="bTopBlue">Command Windows</h1>
<pre>
...
{/* =============================================================================== */}
<h1 className="bTopBlue">Projects</h1>
<pre>
...
{/* =============================================================================== */}
<h1 className="bTopBlue">SQL, etc.</h1>
...
{/* =============================================================================== */}
<h1 className="bTopBlue">Machine Learning</h1>
...
{/* =============================================================================== */}
<h1 className="bTopBlue">Manifest</h1>

<pre>
<p>
To add a manifest to your website, you can follow the steps outlined in the article below.<br /><br />

This will help you create a web app manifest that provides metadata about your web application,<br /> 
such as its name, icons, and theme colors.<br /><br /> 
The manifest allows your web app to be installed on a user's home screen and run in a standalone window,<br />
without the browser's address bar and navigation controls.<br /><br />
This is particularly useful for Progressive Web Apps (PWAs) to enhance the user experience on mobile devices.<br />
<a target="blank" href="https://web.dev/articles/add-manifest">Add Manifest</a>
</p>
</pre>
